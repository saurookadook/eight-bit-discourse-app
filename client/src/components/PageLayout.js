...
{/* <div className="PageHeader bg-warning">
  <div className="row">
    ...
    <img className="PageHeaderImage col-4" src="https://images.pexels.com/photos/163036/mario-luigi-yoschi-figures-163036.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt=""/>
  </div>
</div> */}
...
export const PageLayout = () =>
    <div className="PageHeader">
        <div className="AppDetails">
          <h1 className="AppName">8-bit Discourse</h1>
          <p className="HomeDescription">A place for open discourse about games.</p>
        </div>
        <img
