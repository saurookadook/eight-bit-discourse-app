...
post1 = user3.posts.build(
  title: "Destiny is the worst",
  game: "Destiny",
  discussion: "Literally the biggest disappointment in gaming since Duke Nukem. A ton of hype about an amazing concept that was ultimately a dismal failure.",
  rating: "0",
  user_id: 3
)
post1.save
